#include "./sunsetfilter.h"

void SunsetFilter::init(const effect_config &config) {
  ...
  std::vector<double> x3{0, 41, 183, 201, 256};
  std::vector<double> y3{0, 80,  215, 234, 256};
...
cv::Mat SunsetFilter::apply(cv::Mat &to, const void *data) {
