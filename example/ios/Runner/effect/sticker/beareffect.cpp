#include "beareffect.h"
#include "../common/blend.h"

cv::Mat BearEffect::apply(cv::Mat &to, const void *data) {
...
#ifdef IMG_DEBUG_LOG
  std::cout << "bear effect : " << t*1000 << " milliseconds" << std::endl;
#endif
  return to;
}

BearEffect::~BearEffect() {
  std::cout << "destroy bear effect" << std::endl;
}
